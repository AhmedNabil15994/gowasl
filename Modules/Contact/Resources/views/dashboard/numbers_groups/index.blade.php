...
@section('title', __('contact::dashboard.numbers_groups.routes.index'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('contact::dashboard.numbers_groups.routes.index')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="portlet light bordered">
                    ...
                    @can('add_numbers_groups')
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{ url(route('dashboard.numbers_groups.create')) }}"
                    ...
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">
                                {{__('contact::dashboard.numbers_groups.routes.index')}}
                            </span>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('contact::dashboard.numbers_groups.datatable.channel')}}</th>
                                    <th>{{__('contact::dashboard.numbers_groups.datatable.title')}}</th>
                                    <th>{{__('contact::dashboard.numbers_groups.datatable.status')}}</th>
                                    <th>{{__('contact::dashboard.numbers_groups.datatable.created_at')}}</th>
                                    <th>{{__('contact::dashboard.numbers_groups.datatable.options')}}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                    <div class="row">
                        <div class="form-group">
                            <button type="submit"
                                ...
                                onclick="deleteAllChecked('{{ url(route('dashboard.numbers_groups.deletes')) }}')">
    ...
    function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.numbers_groups.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
...
responsivePriority:1,
                            width: '13%',
                            title: '{{__('contact::dashboard.numbers_groups.datatable.options')}}',
                            className: 'dt-center',
                            orderable: false,
                            render: function (data, type, full, meta) {

                                // Edit
                                var editUrl = '{{ route("dashboard.numbers_groups.edit", ":id") }}';
                                editUrl = editUrl.replace(':id', data);

                                // Delete
                                var deleteUrl = '{{ route("dashboard.numbers_groups.destroy", ":id") }}';
                                deleteUrl = deleteUrl.replace(':id', data);

                                return `
                   @can('delete_numbers_groups')
