...
@section('title', __('user::dashboard.channels.create.title'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('user::dashboard.channels.create.title')}}</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                {!! Form::model($model,[
                'url'=> route('dashboard.channels.store'),
                'id'=>'form',
                'role'=>'form',
                'method'=>'POST',
                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active fade in"
                                 id="global_setting">
                                <div class="col-md-10">
                                    @include('channel::dashboard.channels.form.form')
                                </div>
                            </div>
                            {{-- END CREATE FORM --}}
