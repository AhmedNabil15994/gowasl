...
@section('title', __('offer::vendor.offers.routes.create'))
@section('css')
    <style>
        textarea{
            min-height: 150px;
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{ __('offer::vendor.offers.routes.create') }}</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                <form id="form" role="form" class="form-horizontal form-row-seperated" method="post"
                    enctype="multipart/form-data" action="{{ route('vendor.offers.store') }}">
                    @csrf
                    <div class="col-md-12">
                            ...
                            <div class="tab-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                @foreach($sellers as $seller)
                                                    <option value="{{$seller->id}}" {{$seller->id == auth()->id() ? 'selected' : ''}}>{{$seller->name}}</option>
                                                @endforeach
                                                </select>
                                                <div class="help-block"></div>
                                            </div>
                                ...
                                <div class="tab-pane fade in" id="use">
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <label class="col-md-2">
                                                {{ __('offer::vendor.offers.form.start_at') }}
                                            </label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2">
                                                {{ __('offer::vendor.offers.form.expired_at') }}
                                            </label>
                                            <div class="col-md-9">
                                                <div class="input-group input-medium date time date-picker"
                                                    data-date-format="yyyy-mm-dd" data-date-start-date="+0d">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2">
                                                {{ __('offer::vendor.offers.form.user_max_uses') }}
                                            </label>
                                            <div class="col-md-9">
                                ...
                                <div class="tab-pane fade in" id="media">
                                    <div class="tab-content">
                                        <div class="tab-pane active fade in" id="mediaDiv">
                                            {!! field()->file('main_image',__('offer::vendor.offer.form.image'), $model ?$model->getFirstMediaUrl('images'):'')!!}
                                            {!! field()->file('images[]',__('offer::vendor.offers.form.images'), $model ?$model->getFirstMediaUrl('images'):'' , ['multiple'=>true])!!}
                                            {!! field()->file('video',__('offer::vendor.offers.form.video'), $model ?$model->getFirstMediaUrl('video'):'')!!}
                                ...
                                <div class="tab-pane fade in" id="location">
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2">
                                                {{ __('offer::vendor.offers.form.location_on_map') }}
                                            </label>
                                            <div class="col-md-9">
