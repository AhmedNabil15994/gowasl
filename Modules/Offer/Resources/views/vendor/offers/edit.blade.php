                                ...
                                <div class="tab-pane fade in" id="category">
                                    <div class="tab-content">
                                        <div class="tab-pane active fade in" id="category_level">
                                            ...
                                            <div id="jstree">
                                                @include('category::vendor.tree.categories.edit',['mainCategories' => $mainCategories,'hasRelation' => 1,])
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2">
                                                ...
                                                <i class="fa fa-question-circle tooltips"
                                                   data-original-title="{{ __('offer::vendor.offers.form.tooltips.user_max_uses_tooltip') }}"></i>
                                            </label>
                                            <div class="col-md-9">
                                ...
                                <div class="tab-pane fade in" id="media">
                                    <div class="tab-content">
                                        <div class="tab-pane active fade in" id="mediaDiv">
                                            {!! field()->file('main_image',__('offer::vendor.offers.form.image'), $model->id ? $model->main_image:'')!!}
                                            {!! field()->file('images[]',__('offer::vendor.offers.form.images'), $model->id ? $model->images :'' , ['multiple'=>true])!!}
                                            {!! field()->file('video',__('offer::vendor.offers.form.video'), $model->id ? $model->video :'')!!}
                                        </div>
                                    </div>
                                </div>
