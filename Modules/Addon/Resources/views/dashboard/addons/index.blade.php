...
@section('title', __('addon::dashboard.addons.routes.index'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('addon::dashboard.addons.routes.index')}}</a>
                </li>
            </ul>
        </div>
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{ url(route('dashboard.addons.create')) }}"
                    ...
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">
                                {{__('addon::dashboard.addons.routes.index')}}
                            </span>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('addon::dashboard.addons.datatable.image')}}</th>
                                    <th>{{__('addon::dashboard.addons.datatable.title')}}</th>
                                    <th>{{__('addon::dashboard.addons.datatable.monthly_price')}}</th>
                                    <th>{{__('addon::dashboard.addons.datatable.annual_price')}}</th>
                                    <th>{{__('addon::dashboard.addons.datatable.status')}}</th>
                                    <th>{{__('addon::dashboard.addons.datatable.created_at')}}</th>
                                    <th>{{__('addon::dashboard.addons.datatable.options')}}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                    <div class="row">
                        <div class="form-group">
                            <button type="submit"
                                ...
                                onclick="deleteAllChecked('{{ url(route('dashboard.addons.deletes')) }}')">
    ...
    function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.addons.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
                    ...
                    columns: [
                        ...
                        {data: 'monthly_price' , className: 'dt-center'},
                        {data: 'annual_price' , className: 'dt-center'},
...
responsivePriority:1,
                            width: '13%',
                            title: '{{__('addon::dashboard.addons.datatable.options')}}',
                            className: 'dt-center',
                            orderable: false,
                            render: function (data, type, full, meta) {

                                // Edit
                                var editUrl = '{{ route("dashboard.addons.edit", ":id") }}';
                                editUrl = editUrl.replace(':id', data);

                                // Delete
                                var deleteUrl = '{{ route("dashboard.addons.destroy", ":id") }}';
