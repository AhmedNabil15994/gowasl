...
@section('title', __('category::vendor.categories.routes.index'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('category::vendor.categories.routes.index')}}</a>
                    </li>
                </ul>
            </div>
                        ...
                        @can('add_categories')
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="{{ url(route('vendor.categories.create')) }}"
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('category::vendor.categories.datatable.image')}}</th>
                                    <th>{{__('category::vendor.categories.datatable.title')}}</th>
                                    <th>{{__('category::vendor.categories.datatable.status')}}</th>
                                    <th>{{__('category::vendor.categories.datatable.created_at')}}</th>
                                    <th>{{__('category::vendor.categories.datatable.options')}}</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                <button type="submit" id="deleteChecked" class="btn red btn-sm"
                                        onclick="deleteAllChecked('{{ url(route('vendor.categories.deletes')) }}')">
        ...
        function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('vendor.categories.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
                    ...
                    columnDefs: [
                      ...
                      `;
                        ...
                        },
                        {
                            targets: -1,
                            width: '13%',
                            title: '{{__('category::vendor.categories.datatable.options')}}',
                            className: 'dt-center',
                            orderable: false,
                            render: function (data, type, full, meta) {

                                // Edit
                                var editUrl = '{{ route("vendor.categories.edit", ":id") }}';
                                editUrl = editUrl.replace(':id', data);

                                // Delete
                                var deleteUrl = '{{ route("vendor.categories.destroy", ":id") }}';
