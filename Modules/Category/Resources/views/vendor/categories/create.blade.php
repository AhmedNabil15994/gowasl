...
@section('title', __('category::vendor.categories.routes.create'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('category::vendor.categories.routes.create')}}</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                {!! Form::model($model,[
                                'url'=> route('vendor.categories.store'),
                                'id'=>'form',
                                'role'=>'form',
                                'method'=>'POST',
                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            <div class="tab-pane fade in" id="category_level">
                                ...
                                <div id="jstree">
                                    <ul>
                                        <li id="null">{{ __('category::vendor.categories.form.main_category') }}</li>
                                    </ul>
                                    @include('category::vendor.tree.categories.view',['mainCategories' => $mainCategories])
                                </div>
                            </div>
