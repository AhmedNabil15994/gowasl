...
@section('title', __('user::vendor.users.create.title'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('user::vendor.users.create.title')}}</a>
                </li>
            </ul>
        </div>
                                    ...
                                    <ul class="nav nav-pills nav-stacked">
                                        <li class="active">
                                            <a href="#global_setting"
                                                data-toggle="tab">
                                                {{ __('user::vendor.users.create.form.general') }}
                                            </a>
                                        </li>
                                    </ul>
                                </div>
