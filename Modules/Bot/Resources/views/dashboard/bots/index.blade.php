...
@section('title', __('bot::dashboard.bots.routes.index'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('bot::dashboard.bots.routes.index')}}</a>
                </li>
            </ul>
        </div>
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{ url(route('dashboard.bots.create')) }}"
                    ...
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">
                                {{__('bot::dashboard.bots.routes.index')}}
                            </span>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('bot::dashboard.bots.datatable.channel')}}</th>
                                    <th>{{__('bot::dashboard.bots.datatable.message_type')}}</th>
                                    <th>{{__('bot::dashboard.bots.datatable.message')}}</th>
                                    <th>{{__('bot::dashboard.bots.datatable.reply_type')}}</th>
                                    <th>{{__('bot::dashboard.bots.datatable.status')}}</th>
                                    <th>{{__('bot::dashboard.bots.datatable.created_at')}}</th>
                                    <th>{{__('bot::dashboard.bots.datatable.options')}}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                    <div class="row">
                        <div class="form-group">
                            <button type="submit"
                                ...
                                onclick="deleteAllChecked('{{ url(route('dashboard.bots.deletes')) }}')">
    ...
    function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.bots.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
                    ...
                    columns: [
                        ...
                        {data: 'message_type' , className: 'dt-center'},
                        {data: 'message' , className: 'dt-center'},
                        {data: 'reply_type' , className: 'dt-center'},
...
responsivePriority:1,
                            width: '13%',
                            title: '{{__('bot::dashboard.bots.datatable.options')}}',
                            className: 'dt-center',
                            orderable: false,
                            render: function (data, type, full, meta) {

                                // Edit
                                var editUrl = '{{ route("dashboard.bots.edit", ":id") }}';
                                editUrl = editUrl.replace(':id', data);

                                // Delete
                                var deleteUrl = '{{ route("dashboard.bots.destroy", ":id") }}';
