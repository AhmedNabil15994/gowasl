...
{!! field()->select('channel_id', __('bot::dashboard.bots.form.channel') , $channels->where('id_users',auth()->user()->id)->pluck('name','id')->toArray()) !!}
...
@include('bot::vendor.bots.partials.text')
@include('bot::vendor.bots.partials.image')
@include('bot::vendor.bots.partials.video')
@include('bot::vendor.bots.partials.file')
@include('bot::vendor.bots.partials.audio')
@include('bot::vendor.bots.partials.link')
@include('bot::vendor.bots.partials.sticker')
@include('bot::vendor.bots.partials.gif')
@include('bot::vendor.bots.partials.contact')
@include('bot::vendor.bots.partials.location')
@include('bot::vendor.bots.partials.mention')
