...
@section('title', __('coupon::vendor.coupons.routes.clone'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{ url(route('vendor.coupons.index')) }}">
                            {{__('coupon::vendor.coupons.routes.index')}}
                        </a>
                        <i class="fa fa-circle"></i>
                    </li>
                    <li>
                        <a href="#">{{__('coupon::vendor.coupons.routes.clone')}}</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                <form id="form" role="form" class="form-horizontal form-row-seperated" method="post"
                      enctype="multipart/form-data" action="{{route('vendor.coupons.store')}}">
                    @csrf
                    <div class="col-md-12">
                                            ...
                                            <ul class="nav nav-pills nav-stacked">
                                                <li class="active">
                                                    <a href="#global_setting" data-toggle="tab">
                                                        {{ __('coupon::vendor.coupons.form.tabs.general') }}
                                                    </a>
                                                </li>

                                                <li class="">
                                                    <a href="#use" data-toggle="tab">
                                                        {{ __('coupon::vendor.coupons.form.tabs.use') }}
                                                    </a>
                                                </li>

                                                <li class="">
                                                    <a href="#custom" data-toggle="tab">
                                                        {{ __('coupon::vendor.coupons.form.tabs.custom') }}
                                                    </a>
                                                </li>
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <label class="col-md-2">
                                                {{__('coupon::vendor.coupons.form.title')}}
                                            </label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2">
                                                {{__('coupon::vendor.coupons.form.code')}}
                                            </label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2">
                                                {{__('coupon::vendor.coupons.form.discount_type')}}
                                            </label>
                                            <div class="col-md-9">
                                                <div class="mt-radio-inline">
                                                    <label class="mt-radio mt-radio-outline">
                                                        {{__('coupon::vendor.coupons.form.value')}}
                                                    ...
                                                    <label class="mt-radio mt-radio-outline">
                                                        {{__('coupon::vendor.coupons.form.percentage')}}
                                        ...
                                        <div class="form-group discount_type" id="value" style="display: none">
                                            <label class="col-md-2">
                                                {{__('coupon::vendor.coupons.form.discount_value')}}
                                        ...
                                        <div class="form-group discount_type" id="percentage" style="display: none">
                                            <label class="col-md-2">
                                                {{__('coupon::vendor.coupons.form.discount_percentage')}} %
                                            </label>
                                            <div class="col-md-9">
                                            ...
                                            {{--<label class="col-md-2">
                                                {{__('coupon::vendor.coupons.form.max_discount_percentage_value')}}
                                            </label>
                                            <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2">
                                                {{__('coupon::vendor.coupons.form.status')}}
                                            </label>
                                            <div class="col-md-9">
                                ...
                                <div class="tab-pane fade in" id="use">
                                    <div class="col-md-10">
                                        ...
                                        {{--                                    <div class="form-group">--}}
                                        {{--                                        <label class="col-md-2">--}}
                                        {{--                                            {{__('coupon::vendor.coupons.form.max_users')}}--}}
                                        {{--                                        </label>--}}
                                        {{--                                        <div class="col-md-9">--}}
                                        ...
                                        {{--                                    <div class="form-group">--}}
                                        {{--                                        <label class="col-md-2">--}}
                                        {{--                                            {{__('coupon::vendor.coupons.form.user_max_uses')}}--}}
                                        {{--                                        </label>--}}
                                        {{--                                        <div class="col-md-9">--}}
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2">
                                                {{__('coupon::vendor.coupons.form.start_at')}}
                                            </label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2">
                                                {{__('coupon::vendor.coupons.form.expired_at')}}
                                            </label>
                                            <div class="col-md-9">
                                                <div class="input-group input-medium date time date-picker"
                                                     data-date-format="yyyy-mm-dd" data-date-start-date="+0d">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <div class="col-md-9">
                                                <div class="mt-radio-inline">
                                                    <label class="mt-radio mt-radio-outline">
                                                        {{ __('coupon::vendor.coupons.form.categories') }}
                                                    ...
                                                    <label class="mt-radio mt-radio-outline">
                                                        {{ __('coupon::vendor.coupons.form.products') }}
                                        ...
                                        <div class="form-group" id="categoriesSection"
                                            ...
                                            <div class="col-md-9">
                                                <select name="categories_ids[]" multiple id="single"
                                                        class="form-control select2" data-name="categories_ids[]" data-placeholder="{{ __('coupon::vendor.coupons.form.all_categories') }}">
                                                    <option value=""></option>
                                        ...
                                        <div class="form-group" id="productsSection"
                                            ...
                                            <div class="col-md-9">
                                                <select name="products_ids[]" multiple id="single"
                                                        class="form-control select2" data-name="products_ids[]" data-placeholder="{{ __('coupon::vendor.coupons.form.all_products') }}">
                                                    <option value=""></option>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2">
                                                {{__('coupon::vendor.coupons.form.users')}}
                                            </label>
                                            <div class="col-md-9">
                                                <select name="user_ids[]" multiple id="couponUsersSelect"
                                                        class="form-control select2 coupon-users-select"
                                                        data-name="user_ids[]" data-placeholder="{{ __('coupon::vendor.coupons.form.coupon_users_hint') }}">
