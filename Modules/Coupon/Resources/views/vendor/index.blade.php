...
@section('title', __('coupon::vendor.coupons.routes.index'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('coupon::vendor.coupons.routes.index')}}</a>
                </li>
            </ul>
        </div>
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{ url(route('vendor.coupons.create')) }}" class="btn sbold green">
                                ...
                                <div id="filter_data_table">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-actions">
                                            ...
                                            @include('apps::vendor.components.datatable.show-deleted-btn')
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('coupon::vendor.coupons.datatable.code')}}</th>
                                    <th>{{__('coupon::vendor.coupons.datatable.status')}}</th>
                                    <th>{{__('coupon::vendor.coupons.datatable.expired_at')}}</th>
                                    <th>{{__('coupon::vendor.coupons.datatable.created_at')}}</th>
                                    <th>{{__('coupon::vendor.coupons.datatable.options')}}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                    <div class="row">
                        <div class="form-group">
                            <button type="submit" id="deleteChecked" class="btn red btn-sm" onclick="deleteAllChecked('{{ url(route('vendor.coupons.deletes')) }}')">
  ...
  <script>
   function tableGenerate(data='') {
      ...
      $('#dataTable').DataTable({
          ...
          ajax : {
              url   : "{{ url(route('vendor.coupons.datatable')) }}",
              type  : "GET",
              data  : {
                  req : data,
              },
          ...
          columnDefs: [
      			...
      			},
            {
              ...
              width: '13%',
              title: '{{__('coupon::vendor.coupons.datatable.options')}}',
              className: 'dt-center',
              orderable: false,
              render: function(data, type, full, meta) {

                // Edit
      					var editUrl = '{{ route("vendor.coupons.edit", ":id") }}';
      					editUrl = editUrl.replace(':id', data);

      					// Delete
      					var deleteUrl = '{{ route("vendor.coupons.destroy", ":id") }}';
