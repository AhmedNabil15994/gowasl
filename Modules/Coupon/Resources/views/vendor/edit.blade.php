...
@section('title', __('coupon::vendor.coupons.routes.update'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('coupon::vendor.coupons.routes.update')}}</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                <form id="updateForm" page="form" class="form-horizontal form-row-seperated" method="post"
                      enctype="multipart/form-data" action="{{route('vendor.coupons.update',$coupon->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active fade in" id="global_setting">
                                    <div class="col-md-10">
                                        ...
                                        <hr>
                                        {!! field()->checkBox('add_dates' , __('coupon::vendor.coupons.form.add_dates'),null,[
