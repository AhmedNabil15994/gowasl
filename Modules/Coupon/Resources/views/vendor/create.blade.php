...
@section('title', __('coupon::vendor.coupons.routes.create'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('coupon::vendor.coupons.routes.create')}}</a>
                    </li>
                </ul>
            </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active fade in" id="global_setting">
                                    <div class="col-md-10">
                                        ...
                                        <hr>
                                        {!! field()->checkBox('add_dates' , __('coupon::vendor.coupons.form.add_dates'),null,['onchange' => 'toggleDate(this)',]) !!}
