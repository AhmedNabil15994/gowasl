...
class TemplateServiceProvider extends ServiceProvider
{
    ...
    {
        $this->publishes([
            module_path('Template', 'Config/config.php') => config_path('template.php'),
        ], 'config');
        $this->mergeConfigFrom(
            module_path('Template', 'Config/config.php'),
            'template'
        );
    }
    ...
    public function registerViews()
    {
        ...
        $sourcePath = module_path('Template', 'Resources/views');
    ...
    public function registerTranslations()
    {
        ...
        if (is_dir($langPath)) {
            ...
            $this->loadTranslationsFrom(module_path('Template', 'Resources/lang'), 'template');
        }
    }
    ...
    public function registerFactories()
    {
        if (! app()->environment('production') && $this->app->runningInConsole()) {
            app(Factory::class)->load(module_path('Template', 'Database/factories'));
        }
    }
