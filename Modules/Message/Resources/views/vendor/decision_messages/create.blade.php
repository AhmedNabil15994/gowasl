...
@section('content')
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <form id="form" role="form" class="form-horizontal form-row-seperated" method="post" action="{{route('vendor.decision_messages.store')}}">
                <div class="row">
                <div class="col-md-7">
                        ...
                        <div class="portlet-body form">
                            <div class="form-body" style="padding:0">
                                <div class="form-horizontal msg_details" style="padding: 20px 0">
                                    ...
                                    @include('message::vendor.decision_messages.bulk.message_details',['parentClass'=>'msg_details'])
                        ...
                        <div class="portlet-body form">
                            <div class="">
                                <div class="agree msg_actions">
                                    ...
                                    @include('message::vendor.messages.partials.message_details',['parentClass' => 'agree'])
                                </div>
                                <hr>
                                <div class="refuse msg_actions">
                                    <h4 class="caption-subject bold uppercase">{{__('message::dashboard.refuse')}} ( 2 )</h4>
                                    @include('message::vendor.messages.partials.message_details',['parentClass' => 'refuse'])
                                </div>
...
@section('scripts')
    ...
    <script>
        ...
        $('.send_message').on('click',function (e){
            ...
            $.ajax({
                url: '{{route('vendor.decision_messages.store')}}',
                type: 'POST',
                data: {
                    '_token' : $('meta[name="csrf-token"]').attr('content'),
                ...
                success : function(data) {
                    ...
                    if(data.success) {
                        ...
                        window.location.href = '{{route('vendor.decision_messages.show',":id")}}'.replace(":id",data.id);
                    }
                },
                error: function (error){
                    toastr['error'](error.responseJSON.message)
