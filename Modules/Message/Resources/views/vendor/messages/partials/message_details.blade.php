...
<div class="replies">
    ...
    <div class="reply_msg" id="item-text-inputs">
        @include('message::vendor.messages.partials.text')
    </div>
    <div class="reply_msg hidden" id="item-image-inputs">
        @include('message::vendor.messages.partials.image',['parentClass' => $parentClass ?? null])
    </div>
    <div class="reply_msg hidden" id="item-video-inputs">
        @include('message::vendor.messages.partials.video')
    </div>
    <div class="reply_msg hidden" id="item-file-inputs">
        @include('message::vendor.messages.partials.file')
    </div>
    <div class="reply_msg hidden" id="item-audio-inputs">
        @include('message::vendor.messages.partials.audio')
    </div>
    <div class="reply_msg hidden" id="item-link-inputs">
        @include('message::vendor.messages.partials.link')
    </div>
    <div class="reply_msg hidden" id="item-sticker-inputs">
        @include('message::vendor.messages.partials.sticker')
    </div>
    <div class="reply_msg hidden" id="item-gif-inputs">
        @include('message::vendor.messages.partials.gif')
    </div>
    <div class="reply_msg hidden" id="item-contact-inputs">
        @include('message::vendor.messages.partials.contact')
    </div>
    <div class="reply_msg hidden" id="item-location-inputs">
        @include('message::vendor.messages.partials.location')
    </div>
    <div class="reply_msg hidden" id="item-mention-inputs">
        @include('message::vendor.messages.partials.mention')
    </div>
</div>
