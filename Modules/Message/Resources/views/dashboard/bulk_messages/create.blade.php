                    ...
                    <div class="portlet light bordered types bulk">
                        ...
                        <div class="portlet-body form">
                            <div class="">
                                ...
                                @include('message::dashboard.bulk_messages.bulk.bulk_contacts')

                                <div class="bulk_contacts" id="numbers_groups">
                                    @include('message::dashboard.bulk_messages.bulk.numbers_groups')
                                </div>

                                <div class="bulk_contacts" id="new_contacts" style="display: none">
                                    @include('message::dashboard.bulk_messages.bulk.new_contacts')
                                </div>

                                <div class="bulk_contacts" id="contacts" style="display: none">
                                    @include('message::dashboard.bulk_messages.bulk.contacts')
                                </div>

                                <div class="bulk_contacts" id="excel_contacts" style="display: none">
                                    @include('message::dashboard.bulk_messages.bulk.excel_contacts')
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        function sendBulkMessage (element){
            ...
            $.ajax({
                url : '{{route('dashboard.bulk_messages.store')}}',
                type : 'POST',
                data : formData,
                processData: false,
                contentType: false,
                success : function(data) {
                    ...
                    if(data.success) {
                        ...
                        window.location.href = '{{route('dashboard.bulk_messages.show',":id")}}'.replace(":id",data.id);
                    }
                },
                error: function (error){
                    toastr['error'](error.responseJSON.message)
