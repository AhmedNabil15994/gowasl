        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{ url(route('dashboard.decision_messages.index')) }}">
                                ...
                                <div class="portlet-body form">
                                    <div class="form-body" style="padding:0">
                                        <div class="form-horizontal" style="padding: 20px 0">
                                            ...
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-xs-9">
                                                    <select name="channel_id" class="form-control select2">
                                                        <option value=""></option>
                                                        @foreach($channels->whereChannelId($model->channel_id)->get() as $channel)
                                            ...
                                            @include('message::dashboard.decision_messages.bulk.message_details',['disableTypes' => 1])
                    ...
                    <div class="col-md-12">
                        <div class="form-actions">
                            ...
                            <div class="form-group">
                                <a href="{{url(route('dashboard.messages.index')) }}" class="btn btn-lg red">
    ...
    <script>
        ...
        $(function () {
            ...
            $('select[name="channel_id"]').on('change',function (){
                $.ajax({
                    url: '{{route('dashboard.messages.getChannelData',$model->channel->id)}}'.replace(':id',$(this).val()),
                    type: 'GET',
                    data: {
