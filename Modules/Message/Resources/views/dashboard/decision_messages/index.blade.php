...
{{--                            <div class="col-md-6">--}}
{{--                                <div class="btn-group">--}}
{{--                                    <a href="{{ url(route('dashboard.decision_messages.create')) }}"--}}
                    ...
                    <div class="row">
                        <div class="form-group">
                            <button type="submit"
                                ...
                                onclick="deleteAllChecked('{{ url(route('dashboard.decision_messages.deletes')) }}')">
    ...
    function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.decision_messages.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            ...
                            render: function (data, type, full, meta) {
                                ...
                                // Show
                                var showUrl = '{{ route("dashboard.decision_messages.show", ":id") }}';
                                showUrl = showUrl.replace(':id', data);

                                // Delete
                                var deleteUrl = '{{ route("dashboard.decision_messages.destroy", ":id") }}';
